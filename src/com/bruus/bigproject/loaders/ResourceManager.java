...
public class ResourceManager {
	...
	public void loadImages(PApplet myApplet) {
	  ...
	  // Old dude //
	  oldDudeLeft = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingLeft.png");
	  oldDudeRight = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingRight.png");
	  oldDudeUp = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingUp.png");
	  oldDudeDown = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingDown.png");
	  oldDudeRightUp = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingRightUp.png");
	  oldDudeRightDown = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingRightDown.png");
	  oldDudeLeftUp = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingLeftUp.png");
	  oldDudeLeftDown = myApplet.loadImage(baseFolder + "/Loading_Images/OldDude/OldDudeLookingLeftDown.png");
	...
	public void loadMusic(PApplet myApplet) {
	  ...
	  traderHouseMusic = new SoundFile (myApplet, baseFolder + "/Music_Folder/Parasyte - Next To You (Anime Version).mp3");
